package ma.enset.ensetbot.tools;
...
@Component
public class ToolsAI {
    @Tool(name = "getEtudiant",
    ...
    public Etudiant getEtudiant(@ToolParam(description = "nom d'etudiant") String name){
        return new Etudiant(name, Math.random()*20, 2024);
    }

    @Tool(name = "listEtudiants",
